...
word_dict = {
    ...
    'อาหาร'     :['อาหาร','ทำอาหาร','เครื่องปรุง','วัตถุดิบ','ของหวาน',   'ของกิน','โภชนาการ','แฮม','เจ','กินเจ','มังสวิรัติ','กุ้ง','หอย','วัว','หมู','หมึก','สาหร่าย','เป็ด','ปลา','ปู','เนื้อ','สลัด','ข้าวต้ม','กะปิ','ปลาร้า','ขนมปัง','ซุป','น้ำพริก','ข้าวเหนียว','ลาบ','กะเพรา','ซาบะ'],
...
text_list = ['เมนูอาหารในแต่ละวัน',
'วิธีการเก็บเส้นผมที่ร่วงบนพื้น',
'วิธีการซักเสื้อผ้าให้สะอาด ถนอมผ้าและหอม',
'ปริมาณน้ำในการหุงข้าว',
'ยิ่งอายุเยอะสิวประจำเดือนยิ่งขึ้นเยอะตามทำไงดี',
'มีปัญหากับพ่อแม่ คุยกันไม่รู้เรื่อง เหมือนภาษาไม่ตรงกัน ทำอย่างไรดี',
'หมาล้มป่วย ไม่ยอมกินข้าว ไม่ยอมวิ่งเล่น ควรจะลองทำอย่างไรดี',
'ผัวเป็นอิสลาม ทีนี้ผัวไปชอบผู้หญิงคนอื่น อยากแต่งงานด้วย จึงมาขอเราว่าแต่งด้วยได้มั้ย ทำอย่างไรดีคะ',
'เล่นการ์ดแล้วโดนครูยึด บอกให้แม่มารับ แต่ไม่อยากให้เรื่องไปถึงแม่ ผมควรทำอย่างไรดีครับ',
'กัปตันซึบาสะจะจบมั้ย หรือนักเขียนจะตายก่อน']

desired_tag_list = ['[ มื้อเช้า, มื้อเที้ยง, มื้อเย็น, อาหาร ]',
'[ ผมร่วง, การกำจัดผมร่วง ]',
'[ เสื้อผ้า, น้ำยาปรับผ้านุ่ม, ผงซักฟอก ]',
'[ หุงข้าว, ข้าว ]',
'[ อายุ, ปัจจัยที่ทำให้เกิดสิว, สิว, ประจำเดือน, ฮอร์โมน ]',
'[ ครอบครัว, การสื่อสาร ]',
'[ สัตว์, การรักษาโรค, การดูแลรักษา ]',
'[ ศาสนา, ครอบครัว, ความรัก, วัฒนธรรม, จริยธรรม ]',
'[ การ์ดเกม, ผู้ปกครอง, เรื่องในโรงเรียน ]',
'[ อนิเมะ, มังงะ, ความตาย ]']
...
for i in range(len(text_list)):
    ...
    print("Question :\t",text)
    print("Desired Tag :\t",desired_tag_list[i])
    print("Real Tag :\t",tag_list)
    print()



# text = 'กินผักผลไม้วันละ 1 มื้อ'
# text = 'เลี้ยงน้องเหมียวต้องทำยังไงบ้าง?'
